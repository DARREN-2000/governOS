      ...
      <div className="container px-4 mx-auto md:px-6">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-lg text-muted-foreground">
            Integrate the GovernOS engine directly into your own applications.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            ...
            <Card className="h-full border-border/50 bg-background hover:border-primary/50 transition-colors">
              ...
              <CardContent>
                <p className="text-sm text-muted-foreground mb-4">
                  Programmatically submit intents, retrieve generated plans, and
          ...
          >
            <Card className="h-full border-border/50 bg-background hover:border-primary/50 transition-colors">
              ...
              <CardContent>
                <p className="text-sm text-muted-foreground mb-4">
                  Subscribe to real-time events for policy approvals, workflow
                  completion, and audit triggers.
                </p>
                <code className="text-xs bg-muted px-2 py-1 rounded block mb-2">
