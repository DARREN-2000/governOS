  ...
  const docs = [
    {
      ...
      description: "Get GovernOS running locally in 5 minutes.",
      icon: PlayCircle,
    },
    {
      title: "Architecture Overview",
      description: "Deep dive into the Planner and Executor services.",
      icon: BookOpen,
    },
    {
      title: "Writing Action Plugins",
      description: "Learn the Action SDK and context boundaries.",
      icon: FileCode2,
    },
  ];
      ...
      <div className="container px-4 mx-auto md:px-6">
        <div className="flex flex-col items-center text-center mb-12">
          ...
          <p className="mt-4 text-muted-foreground">
            Everything you need to build secure agentic workflows.
          </p>
        </div>
