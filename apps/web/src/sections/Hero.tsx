  ...
  return (
    <section className="relative overflow-hidden pt-32 pb-20 lg:pt-48 lg:pb-32">
      ...
      <div className="absolute top-0 left-1/2 -z-10 -translate-x-1/2 blur-3xl xl:-top-6">
        <div
          className="aspect-[1155/678] w-[72.1875rem] bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-white/10 via-background to-background"
          style={{
            clipPath:
        ...
        <div className="flex flex-col items-center text-center space-y-8">
          ...
          >
            ...
            <p className="mt-6 text-lg leading-8 text-muted-foreground max-w-2xl mx-auto">
              GovernOS turns natural-language goals into trusted, orchestratable
              workflows. Preview, execute, and audit AI actions with
            ...
            <div className="rounded-xl border border-white/10 bg-card/40 backdrop-blur-xl shadow-2xl overflow-hidden glass animate-float">
              <div className="flex items-center px-4 py-3 border-b border-white/10 bg-muted/30">
                ...
                <div className="mx-auto flex items-center text-xs text-muted-foreground font-mono">
                  <Terminal className="mr-2 h-3 w-3" /> governos plan "deploy
                  production"
                </div>
              </div>
              <div className="p-6 text-left font-mono text-sm leading-relaxed overflow-x-auto text-muted-foreground bg-black/40">
                <p>
                  ...
                  <span className="text-primary/90">governos</span> plan "Scale
                  web tier to 5 replicas"
                </p>
                ...
                <p>
                  1. Update EKS deployment{" "}
                  <span className="text-purple-400">`web-prod`</span>
                </p>
                <p>2. Set replicas = 5</p>
                <br />
                <p className="text-yellow-400">
                  ⚠️ Risk Level: Medium (Requires Approval)
                </p>
                <p className="mt-2">
                  <span className="text-blue-400">?</span> Execute this plan?
                  (Y/n)
                </p>
              </div>
            </div>
