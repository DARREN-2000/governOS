        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground mb-6">
              Giving an LLM direct API access is a security nightmare. Untyped
              outputs, hallucinated parameters, and runaway loops have kept
              autonomous agents out of enterprise production environments.
            </p>
            <div className="space-y-4">
              <div className="flex items-start">
                ...
                <p className="text-muted-foreground">
                  ...
                  Black-box execution leads to unintended infrastructure changes
                  and data loss.
                </p>
              </div>
              <div className="flex items-start">
                ...
                <p className="text-muted-foreground">
                  ...
                  No audit trails, no human-in-the-loop approvals, no policy
                  enforcement.
                </p>
              </div>
              <div className="flex items-start">
                ...
                <p className="text-muted-foreground">
                  <strong className="text-foreground">Context Collapse:</strong>{" "}
                  Agents lack deep understanding of complex codebase
                  dependencies and organizational state.
                </p>
              </div>
            </div>
          </motion.div>
            ...
            <div className="rounded-xl border border-border/50 bg-card p-6 shadow-2xl relative z-10">
              <div className="flex items-center space-x-2 mb-4 border-b border-border pb-4">
                ...
                <div className="text-sm font-mono text-muted-foreground">
                  Direct API Execution (Anti-pattern)
                </div>
              </div>
