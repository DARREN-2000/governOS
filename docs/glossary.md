...
- **Planner:** An LLM or heuristic engine that converts an _Intent_ into a deterministic _Workflow Spec_. GovernOS is not a planner; it orchestrates the output of a planner.
